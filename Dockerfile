...
RUN apt-get install -y --fix-broken  curl gpg wget \
    sudo apt-utils xvfb xfce4 xbase-clients \
    ...
    python3-packaging python3-psutil dbus-x11 libutempter0
RUN wget https://dl.google.com/linux/direct/chrome-remote-desktop_current_amd64.deb
RUN apt-get install -y --fix-broken ./chrome-remote-desktop_current_amd64.deb && rm -f chrome-remote-desktop_current_amd64.deb  
